...
(function(window, document, Context, namespace) {
  ...
  function createRendererPatch(plt, domApi) {
    ...
    function putBackInOriginalLocation(parentElm, i, childNode) {
    ...
    return function patch(oldVNode, newVNode, isUpdatePatch, encapsulation, ssrPatchId, i, relocateNode, slotParentNode, nodeToRelocateParent) {
      ...
      if (checkSlotRelocate) {
        ...
        for (i = 0; i < relocateNodes.length; i++) {
          ...
          nodeToRelocateParent = domApi.$parentNode(relocateNode.nodeToRelocate);
          nodeToRelocateParent !== domApi.$parentNode(relocateNode.slotRefNode) && 
          // add a reference node marking this node's original location
          // keep a reference to this node for later lookups
          domApi.$insertBefore(nodeToRelocateParent, relocateNode.nodeToRelocate['s-ol'] = domApi.$createTextNode(''), relocateNode.nodeToRelocate);
        }
        ...
        for (i = 0; i < relocateNodes.length; i++) {
          relocateNode = relocateNodes[i];
          slotParentNode = domApi.$parentNode(relocateNode.slotRefNode);
          nodeToRelocateParent = domApi.$parentNode(relocateNode.nodeToRelocate);
          if (nodeToRelocateParent !== slotParentNode) {
            ...
            // put it right below the slot comment reference
                        domApi.$insertBefore(slotParentNode, relocateNode.nodeToRelocate, domApi.$nextSibling(relocateNode.slotRefNode));
          }
        }
